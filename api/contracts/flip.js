...
const {web3, web3HTTP} = require('../web3')
const conf = require('../config')
const webtestAddresses = require('../../build/webtest/addresses')

/*
    Abi has been modified. The LogNote event has a bytes field which makes web3
    throw when trying to parse the events. This field has been removed in the abi
*/
...
if(conf.isWebtest()) {
    ...
    exports.contractsHTTP = {
        'ETH': new web3HTTP.eth.Contract(abi, webtestAddresses.ethFlip),
        'BAT': new web3HTTP.eth.Contract(abi, webtestAddresses.batFlip),
        'USDC': new web3HTTP.eth.Contract(abi, webtestAddresses.usdcFlip),
    }
} else {
    exports.flipAddresses = [
        {
    ...
    exports.contractsHTTP = {
        'ETH': new web3HTTP.eth.Contract(abi, '0xd8a04F5412223F513DC55F839574430f5EC15531'),
        'BAT': new web3HTTP.eth.Contract(abi, '0xaA745404d55f88C108A28c86abE7b5A1E7817c07'),
        'USDC': new web3HTTP.eth.Contract(abi, '0xE6ed1d09a19Bd335f051d78D5d22dF3bfF2c28B1'),
    }
}
